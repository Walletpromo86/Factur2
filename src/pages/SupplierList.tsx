    ...
    <div className="supplier-list">
      ...
      <div className="filters">
        <div className="search-container">
          ...
          <input type="text" placeholder="Pesquisar fornecedores..." className="search-input" />
        </div>
          ...
          <tbody>
            {[
              ...
              },
              {
                ...
                email: "sofia@distribuidora.pt",
                phone: "945678901",
                vat: "PT456789012",
              },
              {
                id: "5",
                name: "Importadora Europeia",
                contact: "Miguel Santos",
                email: "miguel@importadora.pt",
                phone: "956789012",
                vat: "PT567890123",
              },
            ].map((supplier) => (
