...
import { FileText, Users, Truck, Euro, TrendingUp, Clock, CheckCircle } from "lucide-react"
          ...
          <main className="flex-1 p-6">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-600 mt-2">Aqui está um resumo do seu sistema de faturas</p>
              </div>
                  ...
                  <CardContent>
                    {recentInvoices.length === 0 ? (
                      <div className="text-center py-8">
                        ...
                        <Button asChild>
                          <Link href="/faturas/new">Criar Primeira Fatura</Link>
                        </Button>
                      </div>
                    ) : (
